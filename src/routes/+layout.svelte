<script lang="ts">
  ...
  import instaLogo from "$lib/svg/insta.svg";
  ...
  >
    <div class="min-w-[120px]">
      ...
      <div class="flex gap-[12px]">
        ...
        >
        <a
          href="https://www.instagram.com/kellerwilliamsmongolia?igsh=N3YwZHNwcHQ2ejU="
          aria-label="Our instagramPage page"
          target="_blank"
        >
          <img class="w-[32px]" src={instaLogo} alt="instagram logo" /></a
        >
        <a
    ...
    <div class="max-[860px]:hidden">
      ...
      <div class="flex align-center gap-1">
        ...
        >
        <div class="leading-none mb-2.5">
          Email: <span class="pl-[21px]">contact@kwmongolia.com</span>
        </div>
      </div>
